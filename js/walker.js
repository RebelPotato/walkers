...
Walker.prototype.createTorso = function() {
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:upper_torso,   ybody:lower_torso});
...
Walker.prototype.createLeg = function() {
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:lower_leg,   ybody:foot});
...
Walker.prototype.createArm = function() {
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:upper_arm,   ybody:lower_arm});
...
Walker.prototype.createHead = function() {
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:head,   ybody:neck});
...
//   this.joints.push(this.world.CreateJoint(jd));
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:this.torso.upper_torso,   ybody:this.right_arm.upper_arm});
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:this.torso.upper_torso,   ybody:this.left_arm.upper_arm});
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:this.torso.lower_torso,   ybody:this.right_leg.upper_leg});
  ...
  jd.motorSpeed = 0;
  jd.enableMotor = true;
  this.joints.push({pjoint:this.world.CreateJoint(jd),  xbody:this.torso.lower_torso,   ybody:this.left_leg.upper_leg});
}
...
Walker.prototype.createGenome = function(joints, bodies) {
  ...
  for(var k = 0; k < joints.length; k++) {
    ...
    */
    //weight [k] is for bias
    gene.weight = [];
    for(var i = 0 ; i < joints.length; i++){
      gene.weight[i] = Math.random()*4-2;
    }
    gene.xweight = Math.random()*4-2;
    gene.yweight = Math.random()*4-2;
...
Walker.prototype.simulationStep = function(motor_noise) {
  ...
  for(var k = 0; k < this.joints.length; k++) {
    ...
    */
    ...
    new_activation[k] = tanh(new_activation[k]);
    this.joints[k].pjoint.SetMotorSpeed((1 + motor_noise*(Math.random()*2 - 1)) * new_activation[k] * config.max_motor_speed);
...
Walker.prototype.makeName = function(genome) {
  ...
  for(var k = 0; k < genome.length; k++) {
    var sum = 0;
    sum += genome[k].xweight*10;
    sum += genome[k].yweight*10;
    for(var l in genome[k].weight) {
      sum += (l*10);
